 ...
 * Expects that there is a class called Config which extends General Tasks
 * Added a method to map additional column data @see
 * The parameters of @see DBase#InitializeLogs() are now optional, Defaults to Config#logLevels and false
 *
 * 
 * @category   Database
 ...
 * @version    0.4
 * @see        DBase#MapOptionalDatabaseData(array)
 */
