 ...
 *  - Allow for objects to throw PDOExceptions instead of swollowing them
 * 
 * Version 1.1
...
class DBase{
    ...
    * @throws Exception
    */
   public function ExecuteQuery($query = '', $query_vars = NULL, $fetchMode = PDO::FETCH_ASSOC, $returnResult = false){
